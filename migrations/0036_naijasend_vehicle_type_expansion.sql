-- Migration 0036: Naijasend Vehicle Type Expansion
--
...
-- belonging to migration "0036_naijasend_vehicle_type_expansion.sql", as closely as a final-state
-- schema dump allows.
--
...
--
-- NOTE: UNKNOWN — SOURCE CODE REQUIRED: 'vehicle_types'/'vehicles' were 
-- already created in 0015 with their final observed column set (which may 
-- include marketplace-listing columns actually added by this migration, e.g. 
-- daily rate or listing status). Column-level attribution to this specific 
-- migration cannot be recovered from a final-state schema dump. 
-- Intentionally-empty placeholder preserving migration-number sequence. 
--
